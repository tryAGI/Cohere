    ...
    public partial class CohereClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                global::Cohere.NotFoundErrorBody4? __value_400 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_400 = global::Cohere.NotFoundErrorBody4.FromJson(__content_400, JsonSerializerContext);
                    }
                    else
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Cohere.ApiException<global::Cohere.NotFoundErrorBody4>(
            ...
            if ((int)__response.StatusCode == 401)
            {
                ...
                global::Cohere.UnauthorizedErrorBody7? __value_401 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_401 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_401 = global::Cohere.UnauthorizedErrorBody7.FromJson(__content_401, JsonSerializerContext);
                    }
                    else
                    {
                        __content_401 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Cohere.ApiException<global::Cohere.UnauthorizedErrorBody7>(
            ...
            if ((int)__response.StatusCode == 403)
            {
                ...
                global::Cohere.BadRequestErrorBody4? __value_403 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_403 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_403 = global::Cohere.BadRequestErrorBody4.FromJson(__content_403, JsonSerializerContext);
                    }
                    else
                    {
                        __content_403 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Cohere.ApiException<global::Cohere.BadRequestErrorBody4>(
            ...
            if ((int)__response.StatusCode == 404)
            {
                ...
                global::Cohere.UnauthorizedErrorBody8? __value_404 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_404 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_404 = global::Cohere.UnauthorizedErrorBody8.FromJson(__content_404, JsonSerializerContext);
                    }
                    else
                    {
                        __content_404 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Cohere.ApiException<global::Cohere.UnauthorizedErrorBody8>(
            ...
            if ((int)__response.StatusCode == 422)
            {
                ...
                global::Cohere.UnprocessableEntityErrorBody4? __value_422 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_422 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_422 = global::Cohere.UnprocessableEntityErrorBody4.FromJson(__content_422, JsonSerializerContext);
                    }
                    else
                    {
                        __content_422 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Cohere.ApiException<global::Cohere.UnprocessableEntityErrorBody4>(
            ...
            if ((int)__response.StatusCode == 429)
            {
                ...
                global::Cohere.GatewayTimeoutErrorBody4? __value_429 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_429 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_429 = global::Cohere.GatewayTimeoutErrorBody4.FromJson(__content_429, JsonSerializerContext);
                    }
                    else
                    {
                        __content_429 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Cohere.ApiException<global::Cohere.GatewayTimeoutErrorBody4>(
            ...
            if ((int)__response.StatusCode == 498)
            {
                ...
                global::Cohere.ForbiddenErrorBody4? __value_498 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_498 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_498 = global::Cohere.ForbiddenErrorBody4.FromJson(__content_498, JsonSerializerContext);
                    }
                    else
                    {
                        __content_498 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Cohere.ApiException<global::Cohere.ForbiddenErrorBody4>(
            ...
            if ((int)__response.StatusCode == 499)
            {
                ...
                global::Cohere.InternalServerErrorBody4? __value_499 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_499 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_499 = global::Cohere.InternalServerErrorBody4.FromJson(__content_499, JsonSerializerContext);
                    }
                    else
                    {
                        __content_499 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Cohere.ApiException<global::Cohere.InternalServerErrorBody4>(
            ...
            if ((int)__response.StatusCode == 500)
            {
                ...
                global::Cohere.ServiceUnavailableErrorBody4? __value_500 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_500 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_500 = global::Cohere.ServiceUnavailableErrorBody4.FromJson(__content_500, JsonSerializerContext);
                    }
                    else
                    {
                        __content_500 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Cohere.ApiException<global::Cohere.ServiceUnavailableErrorBody4>(
            ...
            if ((int)__response.StatusCode == 501)
            {
                ...
                global::Cohere.NotImplementedErrorBody4? __value_501 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_501 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_501 = global::Cohere.NotImplementedErrorBody4.FromJson(__content_501, JsonSerializerContext);
                    }
                    else
                    {
                        __content_501 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Cohere.ApiException<global::Cohere.NotImplementedErrorBody4>(
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                global::Cohere.TooManyRequestsErrorBody4? __value_503 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_503 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_503 = global::Cohere.TooManyRequestsErrorBody4.FromJson(__content_503, JsonSerializerContext);
                    }
                    else
                    {
                        __content_503 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Cohere.ApiException<global::Cohere.TooManyRequestsErrorBody4>(
            ...
            if ((int)__response.StatusCode == 504)
            {
                ...
                global::Cohere.InvalidTokenErrorBody4? __value_504 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_504 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_504 = global::Cohere.InvalidTokenErrorBody4.FromJson(__content_504, JsonSerializerContext);
                    }
                    else
                    {
                        __content_504 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Cohere.ApiException<global::Cohere.InvalidTokenErrorBody4>(
