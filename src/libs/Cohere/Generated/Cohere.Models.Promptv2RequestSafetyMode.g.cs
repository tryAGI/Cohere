...
namespace Cohere
{
    ...
    /// </summary>
    public enum Promptv2RequestSafetyMode
    {
        /// <summary>
    ...
    /// </summary>
    public static class Promptv2RequestSafetyModeExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this Promptv2RequestSafetyMode value)
        {
            return value switch
            {
                Promptv2RequestSafetyMode.Contextual => "CONTEXTUAL",
                Promptv2RequestSafetyMode.Off => "OFF",
                Promptv2RequestSafetyMode.Strict => "STRICT",
        ...
        /// </summary>
        public static Promptv2RequestSafetyMode? ToEnum(string value)
        {
            return value switch
            {
                "CONTEXTUAL" => Promptv2RequestSafetyMode.Contextual,
                "OFF" => Promptv2RequestSafetyMode.Off,
                "STRICT" => Promptv2RequestSafetyMode.Strict,
                _ => null,
            };
        }
    }
