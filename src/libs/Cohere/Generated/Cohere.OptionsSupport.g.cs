...
namespace Cohere
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Cohere.AutoSDKRetryOptions Retry { get; set; } = new global::Cohere.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Cohere.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Cohere.IAutoSDKHook>();
        ...
        public global::Cohere.AutoSDKClientOptions AddHook(
            global::Cohere.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Cohere.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Cohere.AutoSDKClientOptions UseAuthorizationProvider(
            global::Cohere.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Cohere.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Cohere.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Cohere.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Cohere.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Cohere.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Cohere.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Cohere.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Cohere.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Cohere.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Cohere.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Cohere.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Cohere.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Cohere.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Cohere.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Cohere.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Cohere.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Cohere.AutoSDKClientOptions clientOptions,
            global::Cohere.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Cohere.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Cohere.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Cohere.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Cohere.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Cohere.IAutoSDKHook, global::Cohere.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Cohere.AutoSDKHookContext context)
        {
