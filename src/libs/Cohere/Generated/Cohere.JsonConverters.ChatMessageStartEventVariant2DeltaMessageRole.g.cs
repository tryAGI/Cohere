...
namespace Cohere.JsonConverters
{
    ...
    public sealed class ChatMessageStartEventVariant2DeltaMessageRoleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Cohere.ChatMessageStartEventVariant2DeltaMessageRole>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            switch (reader.TokenType)
            {
                case global::System.Text.Json.JsonTokenType.String:
                {
                    ...
                    if (stringValue != null)
                    {
                        return global::Cohere.ChatMessageStartEventVariant2DeltaMessageRoleExtensions.ToEnum(stringValue) ?? default;
                    }
                ...
                {
                    return default(global::Cohere.ChatMessageStartEventVariant2DeltaMessageRole);
                }
                default:
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::Cohere.ChatMessageStartEventVariant2DeltaMessageRoleExtensions.ToValueString(value));
        }
    }
}
