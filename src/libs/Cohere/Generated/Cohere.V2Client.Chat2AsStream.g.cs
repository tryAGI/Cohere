...
namespace Cohere
{
    public partial class V2Client
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Cohere.StreamedChatResponseV2> Chat2AsStreamAsync(
                ...
                else
                {
                    await global::Cohere.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                                ...
                                .Create(__stream).EnumerateAsync(__effectiveCancellationToken))
                            {
                                ...
                                var __streamedResponse = global::Cohere.StreamedChatResponseV2.FromJson(__content, JsonSerializerContext) ??
                                                       throw new global::Cohere.ApiException(
