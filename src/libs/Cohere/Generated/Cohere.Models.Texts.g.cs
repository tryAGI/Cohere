...
namespace Cohere
{
    ...
    public sealed partial class Texts
    {
        ...
        public required global::System.Collections.Generic.IList<string> Texts1 { get; set; }
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Cohere.JsonConverters.TextsTruncateJsonConverter))]
        public global::Cohere.TextsTruncate? Truncate { get; set; } = global::Cohere.TextsTruncate.END;
