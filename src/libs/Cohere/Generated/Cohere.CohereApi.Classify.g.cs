    ...
    public partial class CohereApi
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                throw new global::Cohere.ApiException<global::Cohere.ClassifyResponse2>(
            ...
            if ((int)__response.StatusCode == 401)
            {
                ...
                throw new global::Cohere.ApiException<global::Cohere.ClassifyResponse3>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            if ((int)__response.StatusCode == 403)
            {
                ...
                throw new global::Cohere.ApiException<global::Cohere.ClassifyResponse4>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            if ((int)__response.StatusCode == 404)
            {
                ...
                throw new global::Cohere.ApiException<global::Cohere.ClassifyResponse5>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            if ((int)__response.StatusCode == 422)
            {
                ...
                throw new global::Cohere.ApiException<global::Cohere.ClassifyResponse6>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            if ((int)__response.StatusCode == 429)
            {
                ...
                throw new global::Cohere.ApiException<global::Cohere.ClassifyResponse7>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            if ((int)__response.StatusCode == 498)
            {
                ...
                throw new global::Cohere.ApiException<global::Cohere.ClassifyResponse8>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            if ((int)__response.StatusCode == 499)
            {
                ...
                throw new global::Cohere.ApiException<global::Cohere.ClassifyResponse9>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            if ((int)__response.StatusCode == 500)
            {
                ...
                throw new global::Cohere.ApiException<global::Cohere.ClassifyResponse10>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            if ((int)__response.StatusCode == 501)
            {
                ...
                throw new global::Cohere.ApiException<global::Cohere.ClassifyResponse11>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                throw new global::Cohere.ApiException<global::Cohere.ClassifyResponse12>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            if ((int)__response.StatusCode == 504)
            {
                ...
                throw new global::Cohere.ApiException<global::Cohere.ClassifyResponse13>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
